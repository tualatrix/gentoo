...
src_prepare() {
	...
	patch -p1 < "${FILESDIR}"/00_old_diff_gz.patch
	patch -p1 < "${FILESDIR}"/04_ubuntu_monospace_lcd_filter_conf.patch
	patch -p1 < "${FILESDIR}"/05_lcdfilterlegacy.patch
	patch -p1 < "${FILESDIR}"/05_ubuntu_add_hinting_and_antialiasing_confs.patch
	patch -p1 < "${FILESDIR}"/06_ubuntu_lcddefault.patch
	patch -p1 < "${FILESDIR}"/07_no_bitmaps.patch
